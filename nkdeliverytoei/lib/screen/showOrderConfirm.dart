...
void main() => runApp(ShowOrderConfirm());


class ShowOrderConfirm extends StatefulWidget {

  final OrderListModel listModels;
  ShowOrderConfirm({Key key, this.listModels}) : super(key: key);

  
  
  @override
  _ShowOrderConfirmState createState() => _ShowOrderConfirmState();
}

class _ShowOrderConfirmState extends State<ShowOrderConfirm> {
  ...
  void initState() {
    ...
    orderListModel = widget.listModels;
...
ListView buildListViewNamefood(int index) => ListView.builder(
  ...
  // }
    ...
    // Widget showText() {
    //   return Text('เตรียมสินค้าเรียบร้อยแล้ว', style: TextStyle(color: Colors.red),);
    // }
